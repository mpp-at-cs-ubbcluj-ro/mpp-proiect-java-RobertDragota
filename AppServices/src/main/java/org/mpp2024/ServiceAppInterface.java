...
public interface ServiceAppInterface {
    ...
    Iterable<Trip> Get_All_Trip_By_Destination_From_To(String destination,LocalDateTime date, LocalDateTime startDate, LocalDateTime finishDate) throws AppException;
